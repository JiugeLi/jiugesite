...
export default function SettingsModal({ isOpen, onClose, onDataChange }: SettingsModalProps) {
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-md shadow-2xl transform transition-all overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Data Management</h3>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500">Download backup JSON</div>
                </div>
              </div>
            </button>
